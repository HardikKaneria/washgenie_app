  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Stack(
          children: <Widget>[
            const HomeBodyHeader(userName: "Hardik Kaneria"),
            Positioned(
													...
													text: TextSpan(
														...
														children: <TextSpan>[
															TextSpan(
																...
																style: TextStyle(
																	color: serviceActive
																			? const Color.fromARGB(255, 89, 214, 160)
																			: const Color.fromARGB(255, 255, 84,
																					72), // Dynamically changing color
																),
															),
														],
													),
					...
					children: [
										...
										children: [
											Container(
												...
												decoration: const ShapeDecoration(
													...
													shape: CircleBorder(
														side:
																BorderSide(width: 2, color: Color(0xFF203066)),
													),
												),
											),
						...
						Container(
							...
							child: const Column(
								...
								children: [
									MenuTile(icon: Icons.location_on, title: 'Address'),
									MenuTile(icon: Icons.directions_car, title: 'Vehicles'),
									MenuTile(icon: Icons.book, title: 'Bookings'),
									MenuTile(
											icon: Icons.account_balance_wallet, title: 'My Wallet'),
									MenuTile(icon: Icons.person, title: 'Profile'),
									MenuTile(icon: Icons.exit_to_app, title: 'Log out'),
								],
							),
						)
					],
